...
const SIGHTS = [
  {
    ...
    emoji: "🕯️",
    photo: "https://cdn.poehali.dev/projects/7906f011-65d4-4c4c-a552-fdee1206d99d/bucket/e2fbb276-dfd6-42f5-b330-52bc6d3826ac.jpeg",
  ...
  },
  {
    ...
    emoji: "⛪",
    photo: "https://cdn.poehali.dev/projects/7906f011-65d4-4c4c-a552-fdee1206d99d/bucket/6aed5d33-43fa-4e59-a2c5-061a22958dfc.jpeg",
  ...
  {
    id: 3,
    name: 'МБОУ "Холмечская СОШ"',
    emoji: "🏫",
    photo: "https://cdn.poehali.dev/projects/7906f011-65d4-4c4c-a552-fdee1206d99d/files/84eaa2cd-09d8-4028-9d3c-a93684d62825.jpg",
    address: "пос. Холмечи, Суземский район",
    mapUrl: "https://yandex.ru/maps/?text=Холмечская+СОШ+Суземский+район+Брянская+область",
    desc: "Муниципальная общеобразовательная школа посёлка Холмечи. Учебное заведение Суземского района, объединяющее детей всего посёлка.",
    detail: "Школа является культурным и образовательным центром Холмечей. Здесь учились и учатся поколения жителей посёлка, сохраняя традиции и связь с малой родиной."
  },
];
